...
const VOICES = ["vaulter", "carrier", "weaver", "weaverBolt", "thorn", "drifter", "surger"];
...
H.eq(JSON.stringify(Object.keys(C.SFX_KILL_PITCH)), JSON.stringify(VOICES), "⛔ C.SFX_KILL_PITCH is keyed by the seven sfxVoice values");
