...
// A UUID v4. crypto.randomUUID is secure-context-only, and an opaque origin (a
// sandboxed embed) is never a secure context, so fall back to getRandomValues —
// kit-profile's mintPlayerId, the same rule. The Worker demands a v4 run_id.
function mintRunId() {
