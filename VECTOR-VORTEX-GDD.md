...
⛔ **Shipped, CS013 P1 — the tokens, the drop, and the two instant effects** (`src/10-powerups.js`; `PLANNED-FEATURES-CS013.md` T1–T6, T10, T11, all Paul's recommendations). Lance, Spread and Ward set their flags on pickup and get their effects in CS013 P2.
...
| Lance | 2 | a kill does not consume the shot; a Thorn chip × 3 (P2) | `LANCE_CHIP_MULT` 3 |
| Spread | 2 | fires into lanes −1, 0, +1 (P2) | `SPREAD_SHOT_MAX` 24 |
| Ward | 2 | absorbs one `killSkimmer()` (P2) | — (one hit) |
