...
| `pulse` | E minor, **120 BPM** (80 at P2), 16 steps a bar | 36 bars, **72 s** | A bars 0–11 (the tune low and plain), B 12–23 (an octave up, heart doubles), C 24–35 (the peak; the opening motif returns at bar 32, and a B major bar pulls back to the top) | `melody`, `swell`, `bassline`, `cycle` (**tier 2**), `heart`, `tick` (**tier 3**); the rest foundation (CS010 P3) | 14 |
